"""
RAG-internal display strings for lookup results.

These are formatting templates used by lookup.py to present
structured ACE/term lookup results. They are NOT LLM prompts
and NOT user-facing i18n — they are part of the retrieval
service's response formatting.
"""
...
# ---------------------------------------------------------------------------
# Lookup Tier 3 LLM classify prompt (retrieval-assisting, not generation)
# ---------------------------------------------------------------------------

LOOKUP_CLASSIFY_PROMPT: str = (
...
# ---------------------------------------------------------------------------
# Validation error templates (used by eventsheet_generator → now in Copilot)
# ---------------------------------------------------------------------------
