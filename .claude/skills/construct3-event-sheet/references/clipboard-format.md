...
- [基本结构](#基本结构) - JSON 格式和 type 类型
- [获取正确格式的方法](#获取正确格式的方法)
- [关键注意事项](#关键注意事项) - 剪贴板写入、字符串引号、变量
- [事件结构](#事件结构) - eventType、条件/动作结构
- [Object Types 结构](#object-types-结构)
- [World Instances](#world-instances场景实例)
- [调试与常见错误](#调试与常见错误)
- [不支持剪贴板的元素](#不支持剪贴板的元素)
...
详见 [parameter-types.md](parameter-types.md#comparison-cmp---比较运算符)

### 5. simulate-control 用字符串

详见 [parameter-types.md](parameter-types.md#simulate-control-控制值)
