...
`MyGame` 从 [XHXIAIEIN/Construct3-New-Project](https://github.com/XHXIAIEIN/Construct3-New-Project) 复制而来，即编辑器 **项目** > **新建** 保存的空项目。想改用本机已保存的空项目，在第二条命令后加 `--template <那个文件夹>`。
