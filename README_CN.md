...
prompts/                LLM system prompt：设计指南、书写规则、易错点、游戏项目用的 CLAUDE.md 模板
  references/           按需加载：手工编辑项目 JSON、没有编辑器时的检查
